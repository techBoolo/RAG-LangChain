...
neutral_feedback_message = [
  ("system", "You are a helpful assistant."),
  ("user", "Generate a request for more details for this neutral feedback {feedback}")
]
...
classification_template = ChatPromptTemplate.from_messages(
  [
    ("system", "You are a helpful assistant."),
    ("user", "Classify the sentiment of this feedback as positive, negative, neutral or escalette {feedback}")
  ]
)
